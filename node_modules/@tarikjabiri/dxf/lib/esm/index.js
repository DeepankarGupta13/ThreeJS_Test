...
class Text extends Entity {
    constructor(position, height, value, options) {
...
export { AlignedDimension, AngularDimLines, AngularDimPoints, AppIdFlags, Arc, AssociativityFlag, AttachmentPoint, BlockFlags, BoundingBox, Circle, Colors, DiameterDimension, DimStyleFlags, Dimension, DimensionType, DxfBlock, DxfBlocksSection, DxfLayer, DxfWriter, Ellipse, Face, GradientType, Hatch, HatchArcEdgeData, HatchBoundaryPaths, HatchEdgesTypeData, HatchLineEdgeData, HatchPattern, HatchPatternType, HatchPolylineBoundary, HatchPredefinedPatterns, HatchStyle, Image, ImageClipModeFlag, ImageClippingStateFlag, ImageClippingType, ImageDefResolutionUnits, ImageDisplayFlags, Insert, InvisibleEdgeFlags, LWPolyline, LWPolylineFlags, LayerFlags, Line, LineTypes, LinearDimension, PathTypeFlag, Point, Polyline, PolylineFlags, RadialDimension, SolidFillFlag, Spline, SplineFlags, StyleFlags, SurfaceType, Text, TextGenerationFlags, TextHorizontalAlignment, TextLineSpacingStyle, TextVerticalAlignment, Units, Vertex, VertexFlags, ViewFlags, bulge, createBoundingBox, deg2rad$1 as deg2rad, gradient, pattern, point2d, point3d, rad2deg$1 as rad2deg, vertex };
