...
declare type rectangleOptions_t = LWPolylineOptions & {
    chamfer?: chamfer_t;
    fillet?: number;
};
declare type rgb_t = {
...
declare class Dxfier {
    ...
    variableName(variableName: string): void;
...
declare class Dimension extends Entity {
    blockName?: string;
    definitionPoint?: vec3_t;
    middlePoint?: vec3_t;
...
declare type faceOptions_t = CommonEntityOptions & {
...
declare class Face extends Entity {
    ...
    fourthCorner: vec3_t;
    invisibleEdges: InvisibleEdgeFlags;
    constructor(firstCorner: vec3_t, secondCorner: vec3_t, thirdCorner: vec3_t, fourthCorner: vec3_t, options?: faceOptions_t);
...
declare type HatchOptions_t = CommonEntityOptions & {
    elevation?: number;
    extrusion?: vec3_t;
};
...
declare type ImageOptions_t = CommonEntityOptions & {
...
interface insertOptions_t extends CommonEntityOptions {
...
declare abstract class EntitiesManager implements DxfInterface {
    ...
    add3dFace(firstCorner: vec3_t, secondCorner: vec3_t, thirdCorner: vec3_t, fourthCorner: vec3_t, options?: faceOptions_t): Face;
...
export { AlignedDimOptions, AlignedDimension, AngularDimLines, AngularDimPoints, AppIdFlags, Arc, AssociativityFlag, AttachmentPoint, BlockFlags, BoundingBox, Circle, Colors, CommonEntityOptions, DLine, DiameterDimOptions, DiameterDimension, DimStyleFlags, Dimension, DimensionOptions, DimensionType, DxfBlock, DxfBlocksSection, DxfLayer, DxfWriter, Ellipse, Face, GradientType, Hatch, HatchArcEdgeData, HatchBoundaryPaths, HatchEdgesTypeData, HatchGradientOptions_t, HatchLineEdgeData, HatchOptions_t, HatchPattern, HatchPatternData_t, HatchPatternOptions_t, HatchPatternType, HatchPolylineBoundary, HatchPolylineVertex_t, HatchPredefinedPatterns, HatchStyle, Image, ImageArgs_t, ImageClipModeFlag, ImageClippingStateFlag, ImageClippingType, ImageDefResolutionUnits, ImageDisplayFlags, ImageOptions_t, Insert, InvisibleEdgeFlags, LWPolyline, LWPolylineFlags, LWPolylineOptions, LWPolylineVertex, LayerFlags, Line, LineTypes, LinearDimOptions, LinearDimension, PathTypeFlag, Point, Polyline, PolylineFlags, PolylineOptions, PolylineVertex, RadialDimOptions, RadialDimension, SolidFillFlag, Spline, SplineArgs_t, SplineFlags, StyleFlags, SurfaceType, Text, TextGenerationFlags, TextHorizontalAlignment, TextLineSpacingStyle, TextOptions, TextVerticalAlignment, Units, Vertex, VertexFlags, VertexOptions, ViewFlags, boundingBox_t, bulge, chamfer_t, createBoundingBox, deg2rad, faceOptions_t, gradient, insertOptions_t, pattern, point2d, point3d, rad2deg, rectangleOptions_t, rgb_t, values_t, vec2_t, vec3_t, vertex };
