...
class Hatch extends Entity {
    ...
    dxfy(dx) {
        ...
        dx.name(this.isPattern(this.fill) ? this.fill.name : exports.HatchPredefinedPatterns.SOLID);
        dx.push(70, this.isPattern(this.fill) ? exports.SolidFillFlag.PatternFill : exports.SolidFillFlag.SolidFill);
